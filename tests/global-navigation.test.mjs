...
test("layout does not rely on Safari user-agent sniffing", () => {
	assert.doesNotMatch(layoutSource, /navigator\.userAgent/);
	assert.doesNotMatch(layoutSource, /document\.documentElement\.classList\.add\("is-safari"\)/);
});
